...
<body>
    ...
    <aside class="left-aside position-fixed border-end bg-secondary d-flex flex-column justify-content-between">
        ...
        <div class="time bg-info text-light pt-3 pb-1">
            <h6 id="time" class="text-center" style="font-size: 15px;">123</h6>
        </div>
    </aside>
    ...
    <main class="main-content">
        <div class="container my-3">
            <div class="card mt-4">
                ...
                <div class="card-body">
                    <form action="used-doInsert-product.php" method="post" enctype="multipart/form-data">
                        ...
                        <div class="row">
                            ...
                            <div class="mb-2">
                                ...
                                <input type="text" placeholder="請輸入" class="form-control" value="" name="name">
                            </div>
                            <div class="mb-2">
                                <label for="category">房間分類</label>
                                <select class="form-select" name="category_room">
                                    <option selected class="text-black-50">請選擇房間分類</option>
                            ...
                            <!-- <div class="mb-2">
                                <label for="category">家具分類</label>
                                <select class="form-select" name="category_product">
                                    <option selected class="text-black-50">請選擇傢俱分類</option>
                            ...
                            <div class="mb-2">
                                <label for="number">購買年份</label>
                                <input type="text" placeholder="請輸入" class="form-control" value="" name="bought_time">
                            </div>
                            <div class="mb-2">
                                <label for="number">商品原價格</label>
                                <input type="text" placeholder="請輸入" class="form-control" value="" name="original_price">
                            </div>
                            <div class="mb-2">
                                <label for="number">商品價格</label>
                                <input type="text" placeholder="請輸入" class="form-control" value="" name="price">
                            </div>
                            <div class="mb-2">
